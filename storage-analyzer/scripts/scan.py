...
# macOS Storage Settings often reports large "System Data" outside HOME.
# Probe these locations separately so analysis can explain platform runtimes,
# system caches/logs, and system-wide app remnants instead of hiding them in
# the blue "system and other" bucket.
MAC_SYSTEM_TARGETS = [
    ("system_library", "/Library", 51200),
    ("system_developer", "/Library/Developer", 51200),
    ("core_simulator", "/Library/Developer/CoreSimulator", 51200),
    ("private_var", "/private/var", 51200),
]
...
def scan_macos():
    ...
    for key, path, floor in MAC_SYSTEM_TARGETS:
